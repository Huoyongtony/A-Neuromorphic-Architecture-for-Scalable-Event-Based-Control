...
class Graph:
    ...
    def __init__(
        ...
        node_pos_by_name: Dict[str, Tuple[float, float]] | None = None,
        node_pos_by_id: Dict[str, Tuple[float, float]] | None = None,
        edge_colours_by_node_id: List[Tuple[set[int], str]] | None = None,
    ) -> None:
        # assert input types
        ...
        assert node_pos_by_name is None or isinstance(node_pos_by_name, dict)
        assert edge_colours_by_node_id is None or isinstance(edge_colours_by_node_id, list)
        ...
        self.node_pos_by_name = node_pos_by_name or {}
        self.node_pos_by_id = node_pos_by_id or {}

        self.edge_colours_by_id = edge_colours_by_node_id or []
